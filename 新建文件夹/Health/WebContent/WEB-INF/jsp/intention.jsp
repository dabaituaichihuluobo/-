...
function m1(cid){
	...
	if(a){
		location.href="deleteIntention?cid="+cid
	}
}
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<strong class="card-title">有意向客戶</strong>
						</div>
						<div class="table-stats order-table ov-h">
							<table class="table ">
								...
								<tbody>
									<c:forEach items="${customerList}" var="vip" varStatus="index">
										<tr>
											...
											<td><span>${vip.sales.name}</span></td>
											<td><span class="badge badge-complete"
												onclick="m2(${vip.cid})" style="cursor: pointer;">编辑</span>
												<span class="badge badge-complete"
												onclick="return m1(${vip.cid})" style="cursor: pointer;">删除</span>
											</td>
										</tr>
									</c:forEach>
								</tbody>
